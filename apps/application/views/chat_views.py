...
class Openai(APIView):
    ...
    def post(self, request: Request, application_id: str):
        ...
        return OpenAIChatSerializer(data={'application_id': application_id, 'client_id': request.auth.client_id, "client_ip": client_ip,
                                          'client_type': request.auth.client_type}).chat(request.data, client_ip="3333")
