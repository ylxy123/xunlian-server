    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wechat_push_target', models.CharField(max_length=255, null=True, blank=True)),
                ('last_wechat_push_time', models.DateTimeField(null=True, blank=True)),
                ('push_freq_days', models.IntegerField(null=True, blank=True, default=7)),
            ],
            options={
                'db_table': 'user',
            },
